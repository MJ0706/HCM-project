...
class MEmodel(object):
	...
	self.activeforms = activeforms
        ...
        Kspring = Constant(1.0)#(3.0)   #New
        #Kspringb  = Constant(100)
	Kspringtop = Constant(5.0) 
	...
	return self.uflforms.fiberstrain_1(F_ref=F_ref)
	...
	return self.uflforms.fiberstrain_1(F_ref=F_Identity)


    def GetFiberstrainUL_2(self):

        F_Identity = Identity(self.GetDisplacement().ufl_domain().geometric_dimension())
	return self.uflforms.fiberstrain_2(F_ref=F_Identity)

    def GetFiberstrainUL_3(self):

        F_Identity = Identity(self.GetDisplacement().ufl_domain().geometric_dimension())
	return self.uflforms.fiberstrain_3(F_ref=F_Identity)


    def GetFiberstrainUL_4(self):

        F_Identity = Identity(self.GetDisplacement().ufl_domain().geometric_dimension())
	return self.uflforms.fiberstrain_4(F_ref=F_Identity)

    #######################################################################################

    def GetSheetstrainUL(self):

        F_Identity = Identity(self.GetDisplacement().ufl_domain().geometric_dimension())
	return self.uflforms.sheetstrain(F_ref=F_Identity)

    def GetSheetnormalstrainUL(self):

        F_Identity = Identity(self.GetDisplacement().ufl_domain().geometric_dimension())
	return self.uflforms.normalstrain(F_ref=F_Identity)

    def GetFiberstrainalmansiUL(self):

        F_Identity = Identity(self.GetDisplacement().ufl_domain().geometric_dimension())
	return self.uflforms.fiberstrainalmansi(F_ref=F_Identity)
    ...
    def GetfstressTcauchy(self, AHA_segments):

	return self.uflforms.FiberCauchyStress() + self.activeforms.CalculateFiberCauchyStress(VolSeg = AHA_segments) #self.activeforms.fiberstress()

    ####################################################################################################################

    def GetfstressTPK2(self, AHA_segments):

	return self.uflforms.fiberstress_1() + self.activeforms.CalculateFiberPK2Stress_1(VolSeg = AHA_segments) #self.activeforms.fiberstress()


    def GetfstressTPK2_2(self, AHA_segments):

	return self.uflforms.fiberstress_2() + self.activeforms.CalculateFiberPK2Stress_2(VolSeg = AHA_segments) #self.activeforms.fiberstress()


    def GetfstressTPK2_3(self, AHA_segments):

	return self.uflforms.fiberstress_3() + self.activeforms.CalculateFiberPK2Stress_3(VolSeg = AHA_segments) #self.activeforms.fiberstress()


    def GetfstressTPK2_4(self, AHA_segments):

	return self.uflforms.fiberstress_4() + self.activeforms.CalculateFiberPK2Stress_4(VolSeg = AHA_segments) #self.activeforms.fiberstress()

    ###############################################################################################################################

    def GetsstressTPK2(self, AHA_segments):

	return self.uflforms.sheetstress() + self.activeforms.sheetstress() 

    def GetnstressTPK2(self, AHA_segments):

	return self.uflforms.normalstress() + self.activeforms.sheetnormalstress() 

    def Getfstressactive(self, AHA_segments):

	return self.activeforms.CalculateFiberPK2Stress_1(VolSeg = AHA_segments)
    ...
    def GetFiberStretch(self, F_ED, AHA_segments):

	F_n = self.GetFmat()
	
	return self.activeforms.lmbda_ff_ED(F_ref = F_ED, VolSeg = AHA_segments)


    def GetSheetStretch(self, F_ED, AHA_segments):

	F_n = self.GetFmat()
	
	return self.activeforms.lmbda_ss_ED(F_ref = F_ED, VolSeg = AHA_segments)

    def GetNormalStretch(self, F_ED, AHA_segments):

	F_n = self.GetFmat()
	
	return self.activeforms.lmbda_nn_ED(F_ref = F_ED, VolSeg = AHA_segments)

    def GetFiberStress(self,  AHA_segments):

	return  self.activeforms.CalculateFiberCauchyStress(VolSeg = AHA_segments) # + self.uflforms.FiberCauchyStress() 

    def GetFiberStressPk2(self,  AHA_segments):

	return  self.activeforms.CalculateFiberPK2Stress_2(VolSeg = AHA_segments)


    def GetSheetStress(self,  AHA_segments):

	return  self.activeforms.CalculateSheetCauchyStress(  VolSeg = AHA_segments)  #+self.uflforms.SheetCauchyStress() 


    def GetNormalStress(self,  AHA_segments):

	return self.activeforms.CalculateSheetnormalCauchyStress( VolSeg = AHA_segments) #+self.uflforms.SheetnormalCauchyStress() 
