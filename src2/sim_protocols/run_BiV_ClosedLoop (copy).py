...
def run_BiV_ClosedLoop(IODet, SimDet): 
    ...
    eCC, eRR, eLL, deformedMesh, deformedBoundary = MEmodel_.GetDeformedBasis2({})
    #eFF, eSS, eNN, deformedMesh, deformedBoundary = MEmodel_.GetDeformedBasis({})
    ...
    MEmodel_.GetFiberDirection( e0 = MEmodel_.f0_me, fiberfilename = outdir+ "Eff" )
    MEmodel_.GetFiberDirection( e0 = MEmodel_.s0_me, fiberfilename = outdir+ "Ess" )
    MEmodel_.GetFiberDirection( e0 = MEmodel_.n0_me, fiberfilename = outdir+ "Enn" )
