...
cycle = 10
outdir = './with_disarray_obs_new_1/'
os.mkdir(outdir)
casenames  = [
	      #'./with_dispersion/simulation/P3/k0/simulation_15/LVelectromechanics/LVelectromechanics',\
	      #'./with_dispersion/simulation/P3/k1/simulation_15/LVelectromechanics/LVelectromechanics',\
	      #'./with_dispersion/simulation/P3/k2/simulation_15/LVelectromechanics/LVelectromechanics',\
	      #'./with_dispersion/simulation/P3/k3/simulation_15/LVelectromechanics/LVelectromechanics',\
	      #'./with_dispersion/simulation/P3/k4/simulation_15/LVelectromechanics/LVelectromechanics',\
	      #'./with_dispersion/simulation/P3/k5/simulation_15/LVelectromechanics/LVelectromechanics',\
