...
os.mkdir(outdir)
casenames  = [
	      './with_dispersion/simulation/P3/k0/simulation_15/LVelectromechanics/LVelectromechanics',\
	      #'./with_dispersion/simulation/P3/otg/k0/simulation_13/LVelectromechanics/LVelectromechanics',\
	      './with_dispersion/simulation/P3/otg/k0/simulation_25/LVelectromechanics/LVelectromechanics',\
	      #'./with_dispersion/simulation/P3/otg/k0/simulation_26/LVelectromechanics/LVelectromechanics',\
	      #'../P3/k3/simulation_11/LVelectromechanics/LVelectromechanics',\
	      #'../P3/k4/simulation_11/LVelectromechanics/LVelectromechanics',\
	      #'../P2/k5/simulation/LVelectromechanics/LVelectromechanics',\
	      #'33_LVelectromechanics',\
	      #'a_9_LVelectromechanics',\
	     ]
'''
labels  = [
	      'k= 0',\
