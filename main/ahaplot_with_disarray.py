...
from finalcode.bullseye_plot import LVbullseyemulti6 as LVbullseyemulti
################################################################
...
LVbullseyemulti(data = aharrayworkdensity_s, filename = "Work_density_sheet", Stimulus = "Work_density", DirectorY = directory, maxm =40 , minm = 15)
LVbullseyemulti(data = aharrayworkdensity_n, filename = "Work_density_normal", Stimulus = "Work_density", DirectorY = directory, maxm =0 , minm = -25)
